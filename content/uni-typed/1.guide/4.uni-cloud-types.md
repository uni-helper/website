---
title: uni-cloud-types
description: 为 Vue v3 uni-cloud 组件提供 TypeScript 类型
...
badges:
  - value: npm
    to: https://www.npmjs.com/package/@uni-helper//uni-cloud-types
    target: _blank
  - value: source
    icon: lucide:code
...
:pm-install{name="-D @uni-helper/uni-cloud-types"}
...
![示例](uni-typed/uni-cloud-types-example.jpg)
