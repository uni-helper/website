---
title: uni-app-types
description: 为 Vue v3 uni-app 组件提供 TypeScript 类型
...
badges:
  - value: npm
    to: https://www.npmjs.com/package/@uni-helper/uni-app-types
    target: _blank
  - value: source
    icon: lucide:code
...
:pm-install{name="-D @uni-helper/uni-app-types"}
...
![示例](uni-typed/uni-app-types-example.jpg)
