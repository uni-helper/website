    ...
    >
      ...
      >
        ...
        >
          ...
          >
            <div
              class="absolute inset-0 bg-(--square-light) opacity-0 transition-opacity duration-1000 will-change-[opacity] hover:bg-(--square-hover-light) dark:bg-(--square-dark) dark:hover:bg-(--square-hover-dark)"
