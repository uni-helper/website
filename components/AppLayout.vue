<template>
  <div min-h-screen flex flex-col>
    <header
      ...
      sticky top-0 z-2 border-b bg-inherit bg-light-100 dark:border-dark-200 dark:bg-dark-800
    >
      <div

        mx-auto flex items-center justify-between py-2 container sm:py-4
        class="<sm:p-3"
      >
    ...
    <footer border-t py-4 dark:border-dark-200>
      <div
        ...
        mx-auto flex items-center justify-between gap-4 container
        class="<sm:p-3"
      >
        <div>
          <NuxtLink
